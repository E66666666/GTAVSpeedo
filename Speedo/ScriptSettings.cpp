...
void ScriptSettings::parseSettingsGeneral() {
    ...
    PhysicalSpeed = settingsGeneral.GetBoolValue("SETTINGS", "PhysicalSpeed", false);
...
void ScriptSettings::SaveGeneral() const {
    ...
    std::string unit = "kph";
    if (Unit == UnitType::KPH)
        unit = "kph";
    if (Unit == UnitType::MPH)
        unit = "mph";
    settingsGeneral.SetValue("SETTINGS", "Unit", unit.c_str());
    settingsGeneral.SetBoolValue("SETTINGS", "PhysicalSpeed", PhysicalSpeed);
...
void ScriptSettings::SaveSkin(std::string path, SpeedoInfo& speedoInfo) {
    ...
    for (int i = 0; i < numNOSItemsStage1; i++) {
        skinSettings.SetDoubleValue("LAYOUT", ("NOSStage1_" + std::to_string(i) + "Xpos").c_str(),
                                    speedoInfo.NOSStage1Xpos[i]);
        skinSettings.SetDoubleValue("LAYOUT", ("NOSStage1_" + std::to_string(i) + "Ypos").c_str(),
                                    speedoInfo.NOSStage1Ypos[i]);
        skinSettings.SetDoubleValue("LAYOUT", ("NOSStage1_" + std::to_string(i) + "Size").c_str(),
                                    speedoInfo.NOSStage1Size[i]);
    }

    for (int i = 0; i < numNOSItemsStage2; i++) {
        skinSettings.SetDoubleValue("LAYOUT", ("NOSStage2_" + std::to_string(i) + "Xpos").c_str(),
                                    speedoInfo.NOSStage2Xpos[i]);
        skinSettings.SetDoubleValue("LAYOUT", ("NOSStage2_" + std::to_string(i) + "Ypos").c_str(),
                                    speedoInfo.NOSStage2Ypos[i]);
        skinSettings.SetDoubleValue("LAYOUT", ("NOSStage2_" + std::to_string(i) + "Size").c_str(),
                                    speedoInfo.NOSStage2Size[i]);
    }

    for (int i = 0; i < numNOSItemsStage3; i++) {
        skinSettings.SetDoubleValue("LAYOUT", ("NOSStage3_" + std::to_string(i) + "Xpos").c_str(),
                                    speedoInfo.NOSStage3Xpos[i]);
        skinSettings.SetDoubleValue("LAYOUT", ("NOSStage3_" + std::to_string(i) + "Ypos").c_str(),
                                    speedoInfo.NOSStage3Ypos[i]);
        skinSettings.SetDoubleValue("LAYOUT", ("NOSStage3_" + std::to_string(i) + "Size").c_str(),
                                    speedoInfo.NOSStage3Size[i]);
    }
...
SpeedoInfo ScriptSettings::ReadSkin(std::string path) {
    ...
    for (int i = 0; i < numNOSItemsStage1; i++) {
        speedoInfo.NOSStage1Xpos[i] = static_cast<float>(skinSettings.GetDoubleValue(
            "LAYOUT", ("NOSStage1_" + std::to_string(i) + "Xpos").c_str()));
        speedoInfo.NOSStage1Ypos[i] = static_cast<float>(skinSettings.GetDoubleValue(
            "LAYOUT", ("NOSStage1_" + std::to_string(i) + "Ypos").c_str()));
        speedoInfo.NOSStage1Size[i] = static_cast<float>(skinSettings.GetDoubleValue(
            "LAYOUT", ("NOSStage1_" + std::to_string(i) + "Size").c_str()));
    }

    for (int i = 0; i < numNOSItemsStage2; i++) {
        speedoInfo.NOSStage2Xpos[i] = static_cast<float>(skinSettings.GetDoubleValue(
            "LAYOUT", ("NOSStage2_" + std::to_string(i) + "Xpos").c_str()));
        speedoInfo.NOSStage2Ypos[i] = static_cast<float>(skinSettings.GetDoubleValue(
            "LAYOUT", ("NOSStage2_" + std::to_string(i) + "Ypos").c_str()));
        speedoInfo.NOSStage2Size[i] = static_cast<float>(skinSettings.GetDoubleValue(
            "LAYOUT", ("NOSStage2_" + std::to_string(i) + "Size").c_str()));
    }

    for (int i = 0; i < numNOSItemsStage3; i++) {
        speedoInfo.NOSStage3Xpos[i] = static_cast<float>(skinSettings.GetDoubleValue(
            "LAYOUT", ("NOSStage3_" + std::to_string(i) + "Xpos").c_str()));
        speedoInfo.NOSStage3Ypos[i] = static_cast<float>(skinSettings.GetDoubleValue(
            "LAYOUT", ("NOSStage3_" + std::to_string(i) + "Ypos").c_str()));
        speedoInfo.NOSStage3Size[i] = static_cast<float>(skinSettings.GetDoubleValue(
            "LAYOUT", ("NOSStage3_" + std::to_string(i) + "Size").c_str()));
    }
    ...
    if (skinSettings.GetSectionSize("EXTRA") != -1) {
        ...
        for (int i = 0; i < numDragHeat; i++) {
            speedoInfo.HeatXpos[i] = static_cast<float>(skinSettings.GetDoubleValue(
                "EXTRA", ("Heat" + std::to_string(i) + "Xpos").c_str()));
            speedoInfo.HeatYpos[i] = static_cast<float>(skinSettings.GetDoubleValue(
                "EXTRA", ("Heat" + std::to_string(i) + "Ypos").c_str()));
            speedoInfo.HeatSize[i] = static_cast<float>(skinSettings.GetDoubleValue(
                "EXTRA", ("Heat" + std::to_string(i) + "Size").c_str()));
        }
    }
    else {
